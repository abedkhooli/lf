...
model_name = sys.argv[1] if len(sys.argv) > 1 else "aubmindlab/bert-base-arabertv02"
...
dataset = load_dataset("akhooli/ar_nli_triplets_550") # was load_dataset("sentence-transformers/all-nli", "triplet") 
train_dataset = dataset["train"].select(range(50_000))
eval_dataset = dataset["train"].select(range(50_000,50_500))
test_dataset = dataset["train"].select(range(50_500,60_000))
